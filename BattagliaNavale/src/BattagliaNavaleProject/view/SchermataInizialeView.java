...
public class SchermataInizialeView extends JFrame {
	...
	//Classe che gestisce la visualizzazione della schermata iniziale
	...
	//Metodo per aggiungere un action listener al pulsante registration
	public void addActionReg(ActionListener act)
	{
		registerButton.addActionListener(act);
	}

	//Metodo per aggiungere un action listener al pulsante login
